classdef InputSec < handle
    ...
    methods
        function this = InputSec(panel, s)
            ...
            dd_label.Position(1:3) = [10 140 80];
        ...
        function updatePulse(this, src, ~)
            ...
            % Enable slider only for RCOS or RRCOS pulses
            if strcmp(src.Value, 'RCOS') || strcmp(src.Value, 'RRCOS')
                this.alpha_slider.Enable = 'on';
            else
                this.alpha_slider.Enable = 'off';
            end
        end
